...
/* Name of package */
#define PACKAGE "sierra shellinabox"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "rene.muala@uzambeze.ac.mz"

/* Define to the full name of this package. */
#define PACKAGE_NAME "sierra shellinabox"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "sierra shellinabox 2.20"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "sierra shellinabox"
